      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.row}>
          <View style={styles.card}>
            <Image
              source={require("../assets/quentao.png")}
              style={styles.image}
            />
            <Text style={styles.nome}>Quentão</Text>
          ...
          <View style={styles.card}>
            <Image
              ...
              style={styles.image}
            />
            <Text style={styles.nome}>Água</Text>
        ...
        <View style={styles.row}>
          ...
          <View style={styles.card}>
            <Image
              source={require("../assets/suco.png")}
              style={styles.image}
            />
            <Text style={styles.nome}>Suco Natural</Text>
        ...
        <View>
          <View style={styles.card1}>
            <Image
              ...
              style={styles.image}
            />
            <Text style={styles.nome}>Chocolate-Quente</Text>
